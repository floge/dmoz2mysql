    ...
    function _endTagProcessor($parser, $__tag_name)
    {
        ...
        if (ECHO_STATS) {
            ...
            if ($this->count_rows_temp >= ECHO_STATS_FREQUNCY) {
                ...
                $this->_echoStatus($this->start_time, $this->count_rows,
                    'Yet another ' . ECHO_STATS_FREQUNCY . ' rows reached! - structure RDF document');
            }
        }
    ...
    function _endTagProcessor($__parser, $__tag_name)
    {
        ...
        if (ECHO_STATS) {
            ...
            if ($this->count_rows_temp == ECHO_STATS_FREQUNCY) {
                $this->count_rows_temp = 0;
                $this->_echoStatus($this->start_time, $this->count_rows,
                    'Yet another ' . ECHO_STATS_FREQUNCY . ' rows reached! - content RDF document');
            }
        }
    }
